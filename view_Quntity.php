                                ...
                                <div class="card">
                                    <div class="row">
                                        ...
                                        <div class="card-footer col-6 text-right ">
                                            <button name="submit" class="btn btn-primary  "> <a href="./add-Quntity.php"
                                                    class="text-white"> Add Quantity
                                                </a></button>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                            ...
                                            <table class="table table-striped table-hover" id="tableExport"
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="update-quantity.php?up=<?php echo $qfet['qid']?>"
                                                                class="btn btn-primary"> update</a></td>
                                                        <td><a href="deleted-quantity.php?del=<?php echo $qfet['qid']?>"
