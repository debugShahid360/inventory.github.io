                                    ...
                                    <div class="row">
                                        ...
                                        <div class=" card-footer col-6 text-right ">
                                            <button name="submit" class="btn btn-primary  "> <a
                                                    href="./addcatagories.php" class="text-white"> Add
                                                    Catagories</a></button>
                                        </div>
                                    </div>
                         ...
                         ?>
                                                    <tr>
                                                        ...
                                                        <td><a class="btn btn-success" target="_blank"
                                                                href="update-catagories.php?cid=<?php echo $fet['cid']?>">Update</a>
                                                        </td>
                                                        <td><a class="btn btn-danger" target="_blank"
                                                                href="delete-catagories.php?cid=<?php echo $fet['cid']?>">delete</a>
                                                        </td>
                                                    </tr>
                                                    <?php
