                                ...
                                <div class="card">
                                    <div class="row">
                                        <div class="card-header col-6 ">
                                            <h4>View Supplier Catagories</h4>
                                        </div>
                                        <div class=" card-footer col-6 text-right ">
                                            <button name="submit" class="btn btn-primary  "> <a
                                                    href="./add-supplier.php" class="text-white"> Add Supplier
                                                    </a></button>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                ...
                                while($fet=mysqli_fetch_assoc($run)){
                                    ...
                                    ?>
                                                    <tr>
                                                        ...
                                                        <td><a href="update-supplier.php?up=<?php echo $fet['supid']?>"
                                                                class="btn btn-primary"> update</a></td>
                                                        <td><a href="deleted-supplier.php?del=<?php echo $fet['supid']?>"
